(function() {
	var myModule = {
		 ...
		 */
		goodsList: function(element, id, sliderStatus, subject) {
			var self = this,
				_html = '';
				...
				if (sliderStatus) {
					setTimeout(function() {
						$('#goodsId'+id).swiper({
							...
							slidesPerView: 4,
							slidesPerGroup: 4,
							nextButton: '.J_next' + id,
							prevButton: '.J_prev' + id
						});
					}, 500);
				};
