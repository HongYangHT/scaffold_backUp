(function(){
                        ...
                        _titleList += [
                              '<div class="u-866E-goodsTitle">',
                                ...
                                '<a href="http://you.163.com/item/detail?id=' + data[i].id + '&&_stat_subject=' + _subject + '" title="' + data[i].title + '" target="_blank" class="u-866E-goodsImglink PSC_J_normal_statistics_Goods">',
                                    '<img data-original="' + data[i].primaryPicUrl + '?imageView&thumbnail=260x260&quality=95" class="u-866E-goodsImg J_lazyload">',
                                '</a>',
                             '</div>'
                        ].join('');
                    }
                              ...
                              '<div class="swiper-slide">',
                                    '<div class="u-866E-goods">',
                                        '<a href="http://you.163.com/item/detail?id='+v.id+'&_stat_subject=' + _subject + '" target="_blank" class="u-866E-link PSC_J_normal_statistics_Goods">',
                                            // '<img src="" data-original="' + v.scenePicUrl + '?imageView&thumbnail=520x520&quality=50" class="J_lazyload">',
                                            '<img src="' + v.scenePicUrl + '?imageView&thumbnail=520x520&quality=90">',
                                        '</a>',
                                        '<div class="m-866E-goods-info">',
                                            ...
                                            '<p class="u-866E-goods-price">',
                                                '<span class="u-866E-offPrice">'+v.offPrice +'</span>',
                                                (parseFloat(v.offPrice) == parseFloat(v.unitPrice) ? '' : '<span class="u-866E-unitPrice">' + v.unitPrice + '</span>'),
                                            '</p>',
    ...
    $('.YX-S-M-866E .J_module_info ').each(function(i, n) {
        ...
        myModule.getGoodsRender($(n).closest('.YX-S-M-866E'), _id, window.psc_act_id);
        $('.u-866E-goodsTitle').eq(0).addClass('active');
    });
